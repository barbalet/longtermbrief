/**
 * entity_food.js (mechanical stub port)
 *
 * This file was generated from: entity_food.c
 *
 * The original C implementation is included at the bottom for reference.
 * Replace the stubs with real JS logic as you port features.
 */

export function food_absorption(...args) { throw new Error('TODO: port food_absorption from entity_food.c'); }
export function food_location(...args) { throw new Error('TODO: port food_location from entity_food.c'); }
export function food_values(...args) { throw new Error('TODO: port food_values from entity_food.c'); }
export function food_eat_land(...args) { throw new Error('TODO: port food_eat_land from entity_food.c'); }
export function food_intertidal(...args) { throw new Error('TODO: port food_intertidal from entity_food.c'); }
export function food_eat(...args) { throw new Error('TODO: port food_eat from entity_food.c'); }
